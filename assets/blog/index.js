...
ace.define("ace/mode/numbat_highlight_rules", function(require, exports, module) {
    ...
    var NumbatHighlightRules = function() {
        ...
        this.$rules = {
            "start": [
                ...
                {
                    token: "keyword",
                    regex: "\\b(?:per|to|let|fn|dimension|unit|use|long|short|both|none|print|assert|assert_eq|type|if|then|else|true|false)\\b"
                },
                {
...
ace.define("ace/mode/numbat", function(require, exports, module) {
    ...
    var NumbatHighlightRules = require("ace/mode/numbat_highlight_rules").NumbatHighlightRules;
